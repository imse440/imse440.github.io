...
Please include **IMSE 440** in the email subject line.

**Office hours**

- Wednesdays 10:00 AM - 10:30 AM, in-person at Prof. Feng's office (2320 HPEC)
- Thursdays 3:00 PM - 4:30 PM, on Zoom at <https://umich.zoom.us/my/fredfeng>
- or by appointment
...
- develop methods to make statistical inference from real-world data
- construct appropriate experimental designs for given problems
- perform reproducible data analysis and build appropriate statistical models using standard software packages and development environment
...
<h2><a id="homework">Homework</a></h2>
...
There will be an individual project in the second half of the semester.
...
There is one midterm exam, which is scheduled on **Wednesday, March 24** during the lecture time (11:00 AM - 12:15 PM).
...
- All course work (i.e., homework, readings, project) must represent your own work.
...
- Once you have read this syllabus to completion, please use *cross validation* as the answer to the question in the first homework.
